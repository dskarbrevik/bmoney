...
def test_exact_duplicates():
    ...
    data = [
        {'Date': '2025-01-15', 'Name': 'Amazon', 'Amount': 50.00, 'Account Number': 1234},
        {'Date': '2025-01-15', 'Name': 'Amazon', 'Amount': 50.00, 'Account Number': 1234},
    ]
...
def test_pending_to_posted():
    ...
    data = [
        {'Date': '2025-01-20', 'Original Date': '2025-01-20', 'Name': 'Whole Foods', 
         'Amount': 125.00, 'Account Number': 5678},  # Pending
        {'Date': '2025-01-22', 'Original Date': '2025-01-22', 'Name': 'Whole Foods', 
         'Amount': 124.87, 'Account Number': 5678},  # Posted (final)
    ]
    df = pd.DataFrame(data)
    df['Date'] = pd.to_datetime(df['Date'])
    df['BMONEY_TRANS_ID'] = None
    ...
    assert df_clean.iloc[0]['Amount'] == 124.87, "Should keep the posted (later) version"
    print("\n✅ Test passed!")
...
def test_date_shift():
    ...
    data = [
        {'Date': '2025-01-25', 'Original Date': '2025-01-25', 'Name': 'Chevron', 
         'Amount': 55.00, 'Account Number': 9012},  # Saturday
        {'Date': '2025-01-27', 'Original Date': '2025-01-27', 'Name': 'Chevron', 
         'Amount': 55.00, 'Account Number': 9012},  # Monday (adjusted)
    ]
    df = pd.DataFrame(data)
    df['Date'] = pd.to_datetime(df['Date'])
    df['BMONEY_TRANS_ID'] = None
...
def test_non_duplicates():
    ...
    data = [
        {'Date': '2025-01-28', 'Original Date': '2025-01-28', 'Name': 'Starbucks', 
         'Amount': 5.75, 'Account Number': 1234},
        {'Date': '2025-01-29', 'Original Date': '2025-01-29', 'Name': 'Starbucks', 
         'Amount': 5.75, 'Account Number': 1234},
    ]
    df = pd.DataFrame(data)
    df['Date'] = pd.to_datetime(df['Date'])
...
def test_merge_scenario():
    ...
    master_data = [
        {'Date': '2025-01-15', 'Original Date': '2025-01-15', 'Name': 'Amazon', 
         'Amount': 49.99, 'Account Number': 1234, 'BMONEY_TRANS_ID': 'existing-1'},
        {'Date': '2025-01-20', 'Original Date': '2025-01-20', 'Name': 'Whole Foods', 
         'Amount': 125.00, 'Account Number': 5678, 'BMONEY_TRANS_ID': 'existing-2'},  # Pending
    ]
    ...
    new_data = [
        ...
        {'Date': '2025-01-15', 'Original Date': '2025-01-15', 'Name': 'Amazon', 
         'Amount': 49.99, 'Account Number': 1234, 'BMONEY_TRANS_ID': None},
        # Final posted version of pending transaction (amount changed)
        {'Date': '2025-01-22', 'Original Date': '2025-01-22', 'Name': 'Whole Foods', 
         'Amount': 124.87, 'Account Number': 5678, 'BMONEY_TRANS_ID': None},
        # Completely new transaction
        {'Date': '2025-01-25', 'Original Date': '2025-01-25', 'Name': 'Target', 
         'Amount': 87.50, 'Account Number': 1234, 'BMONEY_TRANS_ID': None},
    ]
    ...
    assert amazon.iloc[0]['BMONEY_TRANS_ID'] == 'existing-1', "Should preserve existing ID"
